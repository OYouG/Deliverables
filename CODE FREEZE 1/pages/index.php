...
WHERE (date="2/12/16" OR date="2/11/16" OR date="2/10/16" OR date="2/9/16" OR date="2/8/16" OR date="2/7/16" OR date="2/6/16" OR date="2/5/16")';
...
WHERE (SproutTwitter.date="2/12/16" OR SproutTwitter.date="2/11/16" OR SproutTwitter.date="2/10/16" OR SproutTwitter.date="2/9/16" OR SproutTwitter.date="2/8/16" OR SproutTwitter.date="2/7/16" OR SproutTwitter.date="2/6/16" OR SproutTwitter.date="2/5/16")';

$sqlTsTotal = 'SELECT SUM(todayGross) AS todayGrosses
        FROM TicketMasterSales
        WHERE (dateToday="2/12/16" OR dateToday="2/11/16" OR dateToday="2/10/16" OR dateToday="2/9/16" OR dateToday="2/8/16" OR dateToday="2/7/16" OR dateToday="2/6/16" OR dateToday="2/5/16")
   		 GROUP BY dateToday';
                        ...
                        <div class="panel-heading">
                            <div class="row">
                                ...
                                <div class="col-xs-9 text-right">
                                    <div class="huge">
	                                     $<?php echo number_format($tsSum); ?> <i class="fa fa-long-arrow-up"></i>
                                    </div>
                    ...
                    <div class="panel panel-green">
                        <div class="panel-heading">
                            <div class="row">
                                ...
                                <div class="col-xs-9 text-right">
                                    <div class="huge">
										<?php echo number_format($wVisitsSum[0]["lastWeekVisits"]); ?> <i class="fa fa-long-arrow-up"></i> 
                                    </div>
                    ...
                    <div class="panel panel-yellow">
                        <div class="panel-heading">
                            <div class="row">
                                ...
                                <div class="col-xs-9 text-right">
                                    <div class="huge"><?php echo number_format($nFollowersSum[0]["Total"]); ?> <i class="fa fa-long-arrow-up"></i>
                                    </div>
    ...
    <script type="text/javascript">
        ...
        //$TODO$ nasty hack
            $(document).ready(function() {
                ...
                controller.renderWVTSMS("2/5/2016", "2/12/2016", webVisits, tixSales, bcSpend);
                controller.renderCoreGraph("2/5/2016", "2/12/2016", webVisits, tixSales);
                controller.renderTSMS("2/5/2016", "2/12/2016", tixSales, adSpend);
            });
        }, 3000);
    </script>
