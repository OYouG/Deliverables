...
$sql = 'SELECT publicationDate, postContent, type, likes 
		FROM TapAnalyticsFacebookPost
		ORDER BY likes DESC
		LIMIT 5';
...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            ...
            <div class="row">
                ...
                <div class="col-lg-12">
                    <h1 class="page-header">Facebook Statistics</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
            <div class="row">
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="table-responsive table-bordered">
                                <table class="table table-striped table-bordered table-hover" id="facebookTable">
                                    <thead>
                                        <tr>
                                    ...
                                    <tbody>
                                        ...
                                        while($row = mysql_fetch_assoc($retval)){
                                            echo "<tr><td>" . $row["publicationDate"]. "</td><td>" . $row["postContent"]. "</td><td>" . $row["type"]. "</td><td>" . $row["likes"]. "</td></tr>";
                                        }
                                        mysql_close($conn);
                                        ?> 
                ...
                <!-- /.col-lg-6 -->                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            Least Liked Facebook Posts
                        </div>
                        <!-- /.panel-heading -->
                        <div class="panel-body">
                            <div class="table-responsive table-bordered">
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function() {
            ...
            controller.renderNewFollowers("2/22/2016", "2/28/2016",[],fbFollows,[],"Facebook");
