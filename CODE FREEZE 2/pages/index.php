...
WHERE (date="2/28/16" OR date="2/22/16" OR date="2/23/16" OR date="2/24/16" OR date="2/25/16" OR date="2/26/16" OR date="2/27/16")';
...
WHERE (SproutTwitter.date="2/28/16" OR SproutTwitter.date="2/22/16" OR SproutTwitter.date="2/23/16" OR SproutTwitter.date="2/24/16" OR SproutTwitter.date="2/25/16" OR SproutTwitter.date="2/26/16" OR SproutTwitter.date="2/27/16")';

$sqlTsTotal = 'SELECT SUM(todayGross) AS todayGrosses
        FROM TicketMasterSales
        WHERE (dateToday="2/28/16" OR dateToday="2/22/16" OR dateToday="2/23/16" OR dateToday="2/24/16" OR dateToday="2/25/16" OR dateToday="2/26/16" OR dateToday="2/27/16")
   		 GROUP BY dateToday';
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div id="topBarStats"> 
	                    <h3>Statistics from 2/22/16 - 2/28/16:</h3> 
	                    <p class="pull-right" style="font-style: italic">Data last updated on 2/28/16 </p> 
                    <hr >
	                </div>
                </div>
                <!-- /.col-lg-12 -->
    ...
    <script type="text/javascript">
        //$TODO$ nasty hack
            $(document).ready(function() {
                ...
                controller.renderWVTSMS("2/22/2016", "2/28/2016", webVisits, tixSales, bcSpend);
                controller.renderCoreGraph("2/22/2016", "2/28/2016", webVisits, tixSales);
                controller.renderTSMS("2/22/2016", "2/28/2016", tixSales, adSpend);
            });
    </script>
