...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            ...
            <div class="row">
                ...
                <div class="col-lg-12">
                    <h1 class="page-header">Instagram Statistics</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
                            ...
                            <div class="table-responsive table-bordered">
                                <table class="table">
                                    ...
                                    <tbody>
										...
										$sql = 'SELECT createdDate, link, caption, likes FROM TapAnalyticsInstagramPost
										ORDER BY likes DESC
										LIMIT 5';
                                        ...
                                        while($row = mysql_fetch_assoc($retval)){
                                            echo '<tr><td>' . $row["createdDate"]. '</td><td><a href="' . $row["link"]. '">'. $row["link"].'</a></td><td>' . $row["caption"]. "</td><td>" . $row["likes"]. "</td></tr>";
                                        }
                                        mysql_close($conn);
                                        ?> 
                                    </tbody>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function() {
            ...
            controller.renderNewFollowers("2/22/2016", "2/28/2016",igFollows,[],[],"Instagram");
