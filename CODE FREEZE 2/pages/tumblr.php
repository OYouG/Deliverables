...
<body>
    ...
    <div id="wrapper">
                    ...
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                                ...
                                <ul class="nav nav-third-level">
                                    ...
                                    <li>
                                        <a href="tumblr.php"><i class="fa fa-tumblr fa-fw"></i> Tumblr Dashboard</a>
                                    </li>
                                    <li>
        ...
        <div id="page-wrapper">
            ...
            <div class="row">
                ...
                <div class="col-lg-12">
                    <h1 class="page-header">Tumblr Statistics</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function() {
            ...
            controller.renderNewFollowers(null,null,"Tumblr");
