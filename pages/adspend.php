                                ...
                                <table class="table table-hover">
                                    ...
                                    <tbody>
                                        ...
                                        while($row = mysql_fetch_assoc($retval)){
                                            echo "<tr><td><a href=\"#" . $row["quarter"] . "\">" . $row["quarter"] . "</a></td><td>" . $row["weeklyTotal"]. "</td><td>" . $row["yearlyTotal"]. "</td></tr>";
                                        }
                                        mysql_close($conn);
                                        ?> 
                            ...
                            <div class="table-responsive table-bordered">
                                <table class="table table-hover">
                                    ...
                                    <tbody>
                                        ...
                                        while($row = mysql_fetch_assoc($retval)){
                                            echo "<tr><td>" . $row["mediaSpend"]. "</td><td>" . $row["total"]. "</td><td>" . $row["percentBudget"]. "</td></tr>";
                                        }
                                        mysql_close($conn);
                                        ?> 
                            ...
                            <div class="table-responsive table-bordered">
                                <table class="table table-hover">
                                    ...
                                    <tbody>
                                        ...
                                        while($row = mysql_fetch_assoc($retval)){
                                            echo "<tr><td>" . $row["name"]. "</td><td>" . $row["startDate"]. "</td><td>" . $row["endDate"]. "</td><td>" . $row["total"]. "</td></tr>";
                                        }
                                        mysql_close($conn);
                                        ?> 
